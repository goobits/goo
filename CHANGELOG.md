...
- Store Vite, coverage, and Playwright artifacts under the configured external cache instead of the source checkout.

## 0.1.0

- Initial publishable package metadata for the Goo Svelte 5 component surface.
